...
function custom_logo() { ?>
 ...
 background-image: url(http://www.cobol.com.co/img/cobol.gif);
...
function custom_logo_url() {
 return "http://www.cobol.com.co";
}
add_filter( 'login_headerurl', 'custom_logo_url' );

function custom_logo_url_titulo() {
 return 'Sitio creado por COBOL INGENIERÍA SAS.';
}
add_filter( 'login_headertitle', 'custom_logo_url_titulo' );