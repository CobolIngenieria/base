						...
						<div class="copyright">
							<?php
								if( mfn_opts_get('footer-copy') ){
									...
									echo '&copy; '. date( 'Y' ) .' '. get_bloginfo( 'name' ) .'. Todos los Derechos Reservados. - Proyecto Desarrollado por <a target="_blank" rel="nofollow" href="https://cobol.com.co">Cobol Ingeniería SAS</a>';
								}
							?>
						</div>
